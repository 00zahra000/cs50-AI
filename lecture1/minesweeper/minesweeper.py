...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        neighbor_cells -= self.safes | self.moves_made
        ...
        for sentence in self.knowledge:
            if len(sentence.cells) == 0:
                ...
                if type(temp_safes) is set:
                    new_safes |= temp_safes
                if type(temp_mines) is type:
                    new_mines |= temp_mines
        ...
        for sentence in self.knowledge:
            if len(sentence.cells) == 0:
                ...
                new_inference.append(Sentence(new_cells, new_count))
            old_sentence = sentence
            self.knowledge += new_inference
    ...
    def make_random_move(self):
        ...
        if len(self.moves_made) == self.width * self.height - 8:
            return None
